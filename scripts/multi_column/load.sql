...
create table d_table(id int PRIMARY KEY, image_embedding float8[1024], text_embedding float8[1024], description text, popularity int, bm25 jsonb);
...
alter table d_table alter bm25 set storage plain;
