...
# round-robin
docker exec -it -u 0 vectordb_cyq bash -c "cp /vectordb/topk_src/topk_round_robin.cpp /vectordb/src/topk.cpp"
docker exec -it -u 0 vectordb_cyq bash -c "mkdir /vectordb/build"
...
docker exec -it vectordb_cyq bash -c "rm /u02/pgdata/13/pg_log/*"

# vbase
docker exec -it -u 0 vectordb_cyq bash -c "cp /vectordb/topk_src/topk_opt.cpp /vectordb/src/topk.cpp"
docker exec -it -u 0 vectordb_cyq bash -c "cd /vectordb/build && cmake .. > build.log 2>&1 && make -j 8 > build.log 2>&1 && make install > build.log 2>&1"
...
# greedy
docker exec -it -u 0 vectordb_cyq bash -c "cp /vectordb/topk_src/topk_greedy.cpp /vectordb/src/topk.cpp"
docker exec -it -u 0 vectordb_cyq bash -c "cd /vectordb/build && cmake .. > build.log 2>&1 && make -j 8 > build.log 2>&1 && make install > build.log 2>&1"
...
docker exec -it -u 0 vectordb_cyq bash -c "cp /vectordb/topk_src/topk_ori.cpp /vectordb/src/topk.cpp"
docker exec -it -u 0 vectordb_cyq bash -c "cd /vectordb/build && cmake .. > build.log 2>&1 && make -j 8 > build.log 2>&1 && make install > build.log 2>&1"
