...
def query_generate(path_img, path_string, count):
    outputfile="/artifacts/scripts/postgres/query_run/table5_sample/sql/query_3_gt.sql"
...
if  __name__ == "__main__":
    ...
    query_generate(args.path_img, args.path_string, args.count)
