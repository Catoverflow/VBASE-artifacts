...
def query_generate(path_img, path_rec, path_price, count):
    outputfile="/artifacts/scripts/postgres/query_run/table5_sample/sql/query_5_gt.sql"
...
if  __name__ == "__main__":
    ...
    query_generate(args.path_img, args.path_rec, args.path_price, args.count)
