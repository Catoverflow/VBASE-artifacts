...
#echo "It will take about 1 week"
#docker exec --privileged --user=root vbase_artifacts bash -c "/artifacts/scripts/postgres/scripts/run.sh"
docker exec --privileged --user=root vbase_artifacts bash -c "cp /artifacts/scripts/postgres/query_run/table5/early_result/* /artifacts/scripts/postgres/query_run/table5/result/"
