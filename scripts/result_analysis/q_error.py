...
parser.add_argument('--full', type=str, default='../data_prepare/datasource.tsv', help='path to full table')
...
for line in tqdm(ffull,total=330922):
    ...
    line = np.fromstring(line[1:-1], dtype=float, sep=',')
...
table=tabulate(table, headers="keys", numalign="right")
print(table)
