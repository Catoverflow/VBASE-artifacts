...
using ::milvus::proto::milvus::CreatePartitionRequest;
using ::testing::_;
using ::testing::AllOf;
...
TEST_F(MilvusMockedTest, CreatePartitionFoo) {
    ...
    EXPECT_CALL(service_, CreatePartition(_,
                                          AllOf(Property(&CreatePartitionRequest::collection_name, collection),

                                                Property(&CreatePartitionRequest::partition_name, partition)),
                                          _))
        .WillOnce([](::grpc::ServerContext*, const CreatePartitionRequest*, ::milvus::proto::common::Status*) {
            return ::grpc::Status{};
        });
