...
IndexBulkDeleteResult *ivfflatbulkdelete(IndexVacuumInfo *info,
  ...
  while (BlockNumberIsValid(nextblkno)) {
    ...
    /* Iterate over lists */
    for (coffno = FirstOffsetNumber; coffno <= cmaxoffno;
         coffno = OffsetNumberNext(coffno)) {
    ...
    for (coffno = FirstOffsetNumber; coffno <= cmaxoffno;
      ...
      while (BlockNumberIsValid(searchPage)) {
        ...
        buf = ReadBufferExtended(index, MAIN_FORKNUM, searchPage, RBM_NORMAL,
                                 bas);
      ...
      if (!BlockNumberIsValid(insertPage)) {
        ...
        IvfflatUpdateList(index, state, listInfo, insertPage,
