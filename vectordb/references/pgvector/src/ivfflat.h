...
#define IVFFLAT_LIST_SIZE(_dim)                                                \
  (offsetof(IvfflatListData, center) + VECTOR_SIZE(_dim))
...
#define VECTOR_ARRAY_SIZE(_length, _dim)                                       \
  (offsetof(VectorArrayData, items) + _length * VECTOR_SIZE(_dim))
#define VECTOR_ARRAY_OFFSET(_arr, _offset)                                     \
  ((char *)_arr + offsetof(VectorArrayData, items) +                           \
   (_offset)*VECTOR_SIZE(_arr->dim))
#define VectorArrayGet(_arr, _offset)                                          \
  ((Vector *)VECTOR_ARRAY_OFFSET(_arr, _offset))
...
IndexBulkDeleteResult *ivfflatbulkdelete(IndexVacuumInfo *info,
                                         ...
                                         void *callback_state);
IndexBulkDeleteResult *ivfflatvacuumcleanup(IndexVacuumInfo *info,
                                            IndexBulkDeleteResult *stats);
